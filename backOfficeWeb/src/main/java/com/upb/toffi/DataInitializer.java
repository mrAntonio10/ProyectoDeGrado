...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createResources(){
        ...
        String idManagementResource = this.createUpdateResource("Gestión", "/management", "work","Recurso padre para la gestión de empresas, sucursales y usuarios",null, 1, root, admin);
        this.createUpdateResource("Empresas", "/enterprise", "business","Recurso encargado de gestionar las empresas dentro del sistema",idManagementResource, 9, root);
        this.createUpdateResource("Sucursales", "/branchOficce", "business","Recurso encargado de gestionar las sucursales dentro del sistema",idManagementResource, 2, root, admin);
        //Recurso Padre - Ajustes
        String idConfigurationResource = this.createUpdateResource("Ajustes", "/configuration", "work","Recurso padre para la gestión de dominios y parámetros del sistema",null, 2, root, admin);
        this.createUpdateResource("Parámetros", "/parameter", "business","Recurso encargado de gestionar parámetros del sistema",idConfigurationResource, 20, root, admin);
        this.createUpdateResource("Dominios", "/domain", "business","Recurso encargado de gestionar los dominios del sistema",idConfigurationResource, 9, root);
